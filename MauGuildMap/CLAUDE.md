...
| `MauGuildMap.xml` | `MauGuildMapPinTemplate`: a 22×22 Frame with a 20×20 `Icon` texture clipped round by a `CircleMask` mask texture, `enableMouseMotion="true"`, `mixin="MauGuildMapPinMixin"`. |
